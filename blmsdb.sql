...
INSERT IGNORE INTO `tblassignlocker` (`ID`, `FullName`, `Email`, `MobileNumber`, `CompleteAddress`, `Occupation`, `LockerSize`, `LockerNumber`, `KeyNumber`, `Instructions`, `NomineeName`, `Relationwithnominee`, `ValuableDetails`, `IDcard`, `IDproof`, `Photo`, `Status`, `LockerAssigndate`) VALUES
